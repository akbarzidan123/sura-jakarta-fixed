...
const FotoCard = () => {
  const fotoListDannn = [
    ...
    {
      src: '/img/AZ4.jpg',
      caption: 'pernah kujadiin pp hihi, chilling di kintamani 😆 ',
    ...
    {
      src: '/img/AZ6.jpg',
      caption: 'harusnya aku udah pernah ngasih si wkwk, foto lebaraaaan',
      positionX: '50%',
      positionY: '50%',
    },
    {
    ...
    { src: '/img/AZ11.jpg', caption: 'bare faceee bleh kali ya' },
    { src: '/img/AZ12.jpg', caption: 'maw sholat nakal dlu' },
  ]
  const fotoListSheii = [
    {
      src: '/img/SA1.jpg',
